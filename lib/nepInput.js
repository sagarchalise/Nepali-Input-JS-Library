            ...
            for(var o in elements){
                if(elements.hasOwnProperty(o)){
                    for(var i=0; i<document.forms[o].elements.length;i++){
                        console.log(elements[o].indexOf(document.forms[o].elements[i].id));
                        if(elements[o].indexOf(document.forms[o].elements[i].id) !== 0 && document.forms[o].elements[i].type === "text" || document.forms[o].elements[i].type === "textarea"){
